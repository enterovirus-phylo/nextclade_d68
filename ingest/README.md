...
| File | Description |
|------|-------------|
| `sequences.fasta` | Curated EV-D68 sequences downloaded from NCBI |
...
For questions or issues specific to this workflow, please [open an issue](https://github.com/enterovirus-phylo/nextclade_d68/issues).